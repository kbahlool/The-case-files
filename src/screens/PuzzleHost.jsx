...
export default function PuzzleHost({ id }) {
  const { cs, prog, puzzleFail, puzzleSolve, back } = useGame();
  ...
  return (
    <Shell title={p.title} noNav>
      <div className="scroll pad">
        ...
        {won ? (
          <div className="win"><small>SOLVED</small><p>{p.lesson}</p>
            <button className="btn primary big" onClick={back}>Back to the investigation</button></div>
