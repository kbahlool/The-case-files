...
export const CASES = [
  ...
  { id: 'case002', number: '002', access: 'LOCKED', teaser: 'A file the department would rather stay shut.' },
  { id: 'case003', number: '003', access: 'COMING_SOON', teaser: 'Someone is writing the next chapter.' },
  { id: 'case004', number: '004', access: 'PREMIUM', teaser: 'Season pass holders only.' },
];
